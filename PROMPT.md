...
- Use `qlc_button_press` for mapped scenes, buttons, cue-list next/previous, blackout, panic, master, or other Virtual Console actions. These actions must exist as dedicated mapped widgets; do not invent `/vc/...`, `/next`, or `/previous` OSC paths.
