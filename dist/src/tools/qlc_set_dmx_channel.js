...
export function createSetDmxChannelTool(config) {
    const logger = getLogger();
    return {
        name: "qlc_set_dmx_channel",
        description: "Set a specific DMX channel value in QLC+ through OSC. Supports both 0-255 and 0-1 normalized ranges.",
        ...
        cb: async (input) => {
            ...
            try {
                ...
                }, { dryRun: config.qlcDryRun }, config);
...
//# sourceMappingURL=qlc_set_dmx_channel.js.map