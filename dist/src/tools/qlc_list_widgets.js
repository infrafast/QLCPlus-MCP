...
export const ListWidgetsInputSchema = z.object({
    type: z.preprocess(nullToUndefined, WidgetTypeSchema.optional()).describe("Only return widgets of this type."),
...
export function createListWidgetsTool() {
    ...
    return {
        ...
        description: "List QLC+ widgets loaded from config/widgets.json, including logical names, OSC paths, types, and descriptions. Use this to discover available mapped widgets before controlling named QLC+ scenes or buttons.",
