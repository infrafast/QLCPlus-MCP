...
export function createGetStateTool() {
    ...
    return {
        name: "qlc_get_state",
        description: "Report QLC+ OSC runtime state: configured host/ports, OSC client initialization, last command sent, feedback listener status, and whether QLC+ feedback was received recently. Use this before answering QLC+ connection/status questions.",
