...
Status: **planned; coordinated with LiveStageAssistant OR4**
...
- [ ] implement `lsa-command-gateway/v1`;
...
- [ ] recognize explicit QLC button commands while preserving the raw caption span;
